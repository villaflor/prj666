                    ...
                    if($getCookieData){
                        ...
                        foreach($getCookieData as $index => $item){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="addProducToCart.php?action=delete&productId=<?php echo $item->good_id; ?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="glyphicon glyphicon-trash"></i></a>
                                </td>
                            </tr>
                        <?php } }
                    else{ ?>
